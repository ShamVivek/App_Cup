        ...
        <nav class="nav container ">
            ...
            <div class="menu" id="mobile-menu">
                <ul class="nav-list d-flex align-items-center">
                    ...
                    <li class="nav-item">
                        <a href="ContactUs.php" class="nav-link  nav-active">Contact Us</a>
                    </li>
                    <li class="nav-item">
                        <a href="ContactUs_Fr.php" class="nav-link">Language:French</a>
                    </li>
                </ul>
        ...
        <section class="background">
            <div class="background-container container d-grid">
                <div class="background-data" id="background-data">
                    ...
                    <h2 class="title main-title">Let's Get in Touch!</h2>
                </div>
            </div>
